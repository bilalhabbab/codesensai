...
import { Box, Text, Avatar, Stack, Heading, Spinner, Center, HStack } from '@chakra-ui/react';
...
const Profile = () => {
  ...
  // Ensure profileData and profileData.problems are not null/undefined
  const problems = profileData?.problems ? Object.keys(profileData.problems).map((problem, index) => {
  ...
  }) : <Text>No problems solved yet.</Text>; // Fallback if no problems are available
